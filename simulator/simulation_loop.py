...
class EventDrivenSimulation:
    ...
    def __init__(
        ...
        self.total_output_tokens = 0  # Total tokens generated by completed requests
    ...
    def _handle_decode_complete(self, request_id: str) -> None:
        ...
        # Track total output tokens for completed requests
        self.total_output_tokens += request.target_output_tokens
    ...
    def get_metrics_summary(self) -> Dict:
        ...
        # Calculate throughput: requests per second and tokens per second
        ...
        throughput_tokens_per_sec = self.total_output_tokens / simulation_time_sec if simulation_time_sec > 0 else 0.0
