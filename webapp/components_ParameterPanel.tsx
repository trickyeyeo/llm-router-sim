...
export default function ParameterPanel({ onRun, disabled }: ParameterPanelProps) {
  ...
  return (
    <div className="bg-slate-800 border border-slate-700 rounded-lg p-6 h-fit sticky top-8">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-700/50 rounded p-3 text-sm">
          <p className="text-slate-300">
            Estimated requests: <span className="font-semibold text-green-400">{sessions * turns}</span>
          </p>
          <p className="text-slate-400 text-xs mt-1">
            Running both stateless & stateful simulations
          </p>
        </div>
